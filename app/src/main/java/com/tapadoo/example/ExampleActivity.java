...
public class ExampleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnAlertOutsideClickable).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnAlertOutsideClickable: {
                showAlertOutsideClickable();
            }
            default: {
                showAlertDefault();
            }
    ...
    private void showAlertOutsideClickable() {
        Alerter.create(ExampleActivity.this)
                .setTitle("Alert Title")
                .setText("Alert text...")
