...
public class JavaDemoActivity extends AppCompatActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(com.tapadoo.alerter.demo.R.id.btnImageAndTextCenterHorizontal).setOnClickListener(this);
	}
	...
	public void onClick(View view) {
		...
		if (i == com.tapadoo.alerter.demo.R.id.btnAlertColoured) {
			...
			showAlertFromBottom();
		} else if (i == com.tapadoo.alerter.demo.R.id.btnImageAndTextCenterHorizontal) {
	...
	private void showAlertCenterIconAndText() {
		Alerter.create(this)
				.setText("short title")
				.showIcon(true)
